...
- `0.5.1`: Admin page adds data-quality review candidates for stale auto-solve locks, same start pins, and name conflicts.
...
All generated code and text were reviewed and adapted by a human before
publication.
